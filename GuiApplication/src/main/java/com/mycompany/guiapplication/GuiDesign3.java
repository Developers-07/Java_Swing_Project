 ...
 * @author Zishan Kabir
 */
public class GuiDesign3 extends javax.swing.JFrame {

    /**
     * Creates new form GuiDesign3
     */
    public GuiDesign3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(159, 141, 41));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabel3.setText(name1+" is the capital of "+name2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiDesign3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiDesign3().setVisible(true);
            }
        });
    }
